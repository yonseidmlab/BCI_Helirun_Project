...
public class SendParticle_alpha_Person1_Soyeon : MonoBehaviour
{
    ParticleSystem ps;
    ...
    private const string address = "Person1/elements/alpha_relative";
    ...
    public void ReceiveDoubleAlpha(OSCMessage message)
    {
        ...
        if (address == "Person1/elements/alpha_relative")
        {
