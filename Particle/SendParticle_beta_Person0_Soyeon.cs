...
public class SendParticle_beta_Person0_Soyeon : MonoBehaviour
{
    ParticleSystem ps;
    ...
    private const string address = "Person0/elements/beta_relative";
    ...
    public void ReceiveDoubleBeta(OSCMessage message)
    {
        ...
        if (address == "Person0/elements/beta_relative")
        {
