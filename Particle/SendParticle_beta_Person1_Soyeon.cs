...
public class SendParticle_beta_Person1_Soyeon : MonoBehaviour
{
    ParticleSystem ps;
    ...
    private const string address = "Person1/elements/beta_relative";
    ...
    public void ReceiveDoubleBeta(OSCMessage message)
    {
        ...
        if (address == "Person1/elements/beta_relative")
        {
