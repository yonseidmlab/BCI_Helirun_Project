...
public class SendParticle_alpha_Person2_Soyeon : MonoBehaviour
{
    ParticleSystem ps;
    ...
    private const string address = "Person2/elements/alpha_relative";
    ...
    public void ReceiveDoubleAlpha(OSCMessage message)
    {
        ...
        if (address == "Person2/elements/alpha_relative")
        {
